  ...
  return (
    <View>
      <Text style={styles.sectionLabel}>
        {title}{" "}
        <Text style={styles.sectionCount}>{matches.length} matches</Text>
      </Text>
      <View style={styles.grid}>
        {matches.map((m) => (
          <MatchCard key={m.reference_id} m={m} onPress={() => onPress(m)} />
        ))}
      </View>
    </View>
  );
